      ...
      map.addLayer({
        ...
        paint: {
          "circle-radius": [
            ...
            ["linear"],
            ["get", metric],
            ...colorScale.flatMap((s) => [s.value, getRadiusForValue(s.value, metric) * 2.5]),
          ],
          "circle-color": [
            "interpolate",
            ["linear"],
      ...
      map.addLayer({
        ...
        paint: {
          "circle-radius": [
            ...
            ["linear"],
            ["get", metric],
            ...colorScale.flatMap((s) => [s.value, getRadiusForValue(s.value, metric)]),
          ],
          "circle-color": [
            "interpolate",
            ["linear"],
      ...
      map.addLayer({
        ...
        paint: {
          "circle-radius": [
            ...
            ["linear"],
            ["get", metric],
            ...colorScale.flatMap((s) => [s.value, getRadiusForValue(s.value, metric) * 0.3]),
          ],
          "circle-color": "#ffffff",
          "circle-opacity": 0.4,
        },
          ...
          popup
            ...
            .setHTML(
              `<div style="padding: 12px; font-family: system-ui;">
                 <div style="font-size: 14px; font-weight: bold; margin-bottom: 8px; color: #374151;">${props.cbsa}</div>
                 <div style="font-size: 12px; color: #6b7280; margin-bottom: 4px;">
                   <span style="font-weight: 500;">Claims Volume:</span> ${props.claimsVolume.toLocaleString()}
                 </div>
                 <div style="font-size: 12px; color: #6b7280;">
                   <span style="font-weight: 500;">Rate Relativity:</span> ${props.rateRelativity}${legendUnit}
                 </div>
               </div>`,
            )
            .addTo(map)
