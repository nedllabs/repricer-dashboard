...
export function MethodologySelector() {
  ...
  const [collapsedCategories, setCollapsedCategories] = useState<Set<string>>(
    new Set(["Outpatient", "Professional", "Others"])
  );
  ...
  const getSelectedMethodologyName = () => {
    ...
    const methodology = methodologyOptions.methodologies.find(
    ...
    <div className="bg-white rounded-xl p-6 shadow-sm border border-[#e5e7eb]">
      <div className="mb-6">
        ...
        <p className="text-sm text-[#6b7280]">
          Choose a type to filter the data
        </p>
      </div>
      ...
      <div className="space-y-1">
        ...
        {Object.entries(groupedMethodologies).map(([category, items]) => {
          ...
          const categoryColor =
            methodologyOptions.categoryColors[
              category as keyof typeof methodologyOptions.categoryColors
            ];
            ...
            >
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <span className="font-semibold text-[#374151] font-comfortaa">
                    {category}
                  </span>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-[#6b7280] mt-1 leading-relaxed">
